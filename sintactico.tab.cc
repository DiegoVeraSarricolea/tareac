...
#line 146 "sintactico.tab.cc"
  ...
  trayect_parser::syntax_error::~syntax_error () YY_NOEXCEPT YY_NOTHROW
  {}
  ...
  // by_state.
  trayect_parser::by_state::by_state () YY_NOEXCEPT
    : state (empty_state)
  {}

  trayect_parser::by_state::by_state (const by_state& that) YY_NOEXCEPT
    : state (that.state)
  {}

  void
  trayect_parser::by_state::clear () YY_NOEXCEPT
  {
    state = empty_state;
  }
  ...
  trayect_parser::by_state::by_state (state_type s) YY_NOEXCEPT
    : state (s)
  {}

  trayect_parser::symbol_number_type
  trayect_parser::by_state::type_get () const YY_NOEXCEPT
  {
  ...
  trayect_parser::stack_symbol_type::stack_symbol_type (YY_RVREF (stack_symbol_type) that)
  ...
  trayect_parser::stack_symbol_type::stack_symbol_type (state_type s, YY_MOVE_REF (symbol_type) that)
  ...
  trayect_parser::stack_symbol_type&
  trayect_parser::stack_symbol_type::operator= (stack_symbol_type& that)
  {
    state = that.state;
    switch (that.type_get ())
    {
  ...
  void
  trayect_parser::yypush_ (const char* m, YY_MOVE_REF (stack_symbol_type) sym)
  {
    if (m)
  ...
  void
  trayect_parser::yypush_ (const char* m, state_type s, YY_MOVE_REF (symbol_type) sym)
  {
#if 201103L <= YY_CPLUSPLUS
